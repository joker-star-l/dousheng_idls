...
type User interface {
	UserInfo(ctx context.Context, userId int64) (r *UserInfoResponse, err error)
}
...
func (p *UserClient) UserInfo(ctx context.Context, userId int64) (r *UserInfoResponse, err error) {
